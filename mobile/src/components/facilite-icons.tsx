...
// Logo Google 4 couleurs — même tracé que src/app/login/page.js (web), pour
// que le bouton "Continuer avec Google" soit identique sur les deux
// plateformes plutôt qu'un pictogramme Ionicons monochrome approximatif.
