...
export const DEFAULT_FEATURE_TREE = [
  {
    ...
    children: [
      ...
      {
        id: "feat_offres_recherche",
        name: "Recherche d'Offres (Mots-clés / Titre)",
        path: "/offres",
        icon: "🔍",
        enabled: true,
        roles: { user: true, recruiter: true, visitor: true },
        description: "Champ de recherche par titre de poste, compétence ou nom d'entreprise",
      },
      {
        id: "feat_offres_filtre_ville",
        name: "Filtre Localisation / Ville",
        path: "/offres",
        icon: "📍",
        enabled: true,
        roles: { user: true, recruiter: true, visitor: true },
        description: "Filtre géographique par ville ou région sur les offres d'emploi",
      },
      {
        ...
        enabled: true,
        roles: { user: true, recruiter: true, visitor: true },
        description: "Bouton et moteur de recherche sémantique par intelligence artificielle",
      },
      {
