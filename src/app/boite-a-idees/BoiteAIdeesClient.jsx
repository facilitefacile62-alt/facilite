    ...
    <>
            ...
            <div className="bg-white border-t border-gray-200 divide-y divide-gray-150 mt-auto">
              ...
              <div className="flex flex-col">
                <button
                  ...
                  onClick={() => {
                    setMobileMenuOpen(false);
                    openFaciliteWhatsApp({ page: "Boîte à idées" });
                  }}
      ...
      <footer className="bg-[#080E1E] text-gray-400 py-16 px-6 md:px-12 border-t border-gray-800">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col">
            <Link href="/" className="flex items-center space-x-2.5 mb-4 group cursor-pointer" title="Aller à l'accueil Facilité">
              ...
              <h3 className="text-white text-xl font-extrabold group-hover:text-[#10E688] transition">À propos de Facilité</h3>
            </Link>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex items-center space-x-3">
              <a
                href={getFaciliteWhatsAppUrl({ page: "Boîte à idées (Footer)" })}
                target="_blank"
          ...
          <div className="flex flex-col">
            ...
            <div className="flex space-x-4">
              ...
              <a
                href={getFaciliteWhatsAppUrl({ page: "Boîte à idées (Réseaux)" })}
                target="_blank"
                rel="noopener noreferrer"
                className="w-11 h-11 bg-gray-900 rounded-2xl flex items-center justify-center text-white hover:bg-[#10E688] hover:text-black transition-all border border-gray-800 shadow-md"
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-gray-800/80 text-center text-xs text-gray-500 font-medium">
          <p>© 2026 Facilité. Tous droits réservés.</p>
        </div>
      </footer>
              ...
              <>
                <div className="mb-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 p-3 bg-gray-50 border border-gray-150 rounded-2xl">
                    <a
                      href={getFaciliteWhatsAppUrl({ page: "Formulaire Contact Boîte à idées" })}
                      target="_blank"
                      rel="noopener noreferrer"
