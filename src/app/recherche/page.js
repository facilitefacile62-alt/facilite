...
// Services statiques du site
const SITE_SERVICES = [
  {
    id: "creer-cv",
    title: "Création & Modèles de CV",
    category: "Services",
    description: "Concevez un CV professionnel de haute qualité optimisé pour les recruteurs et le format ATS.",
  ...
  },
  {
    ...
    category: "Services",
    description: "Importez votre CV (PDF/DOCX) pour obtenir un score ATS instantané et des conseils d'optimisation.",
  ...
  },
  {
    ...
    category: "Services",
    description: "Accédez à la liste complète des entreprises et réseaux pétroliers au Sénégal.",
    icon: "fa-paper-plane",
  ...
  },
  {
    ...
    category: "Services",
    description: "Consultez les adresses et téléphones pour dépôts de candidatures physiques à Dakar.",
    icon: "fa-gas-pump",
  ...
  },
  {
    ...
    category: "Services",
    description: "Échangez en temps réel avec des recruteurs et suivez l'avancement de vos demandes.",
    icon: "fa-comments",
    path: "/messagerie",
  },
  {
    ...
    category: "Services",
    description: "Proposez des améliorations pour enrichir la plateforme Facilite.",
    icon: "fa-lightbulb",
    path: "/boite-a-idees",
  },
];
