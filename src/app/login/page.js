...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[calc(100dvh-60px)] bg-[#FAF6F1] bg-[url('/facilite-pattern-background.svg')] bg-repeat font-sans flex flex-col justify-start items-center pt-6 sm:pt-8 pb-8 px-3 sm:px-4 relative select-none">
