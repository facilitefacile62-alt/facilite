  ...
  useEffect(() => {
    async function loadOrders() {
      try {
        ...
        // La lecture de `transactions` a été retirée avec la recharge de
        // crédits (2026-08-28) : plus rien ne l'affichait, c'était une
        // requête pour rien à chaque ouverture de la page.
