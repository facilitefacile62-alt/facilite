...
-- Ces comptes correspondent √† ceux attendus par la suite Playwright (tests/e2e/*, tests/security/*)
...
-- 3. Mise √† jour des r√¥les et statuts
...
-- Marquer comme comptes de test et v√©rifier les badges
...
-- Assigner les badges pour e2e-test-security (recruteur v√©rifi√©)
UPDATE public.profiles
...
-- Candidature fictive liÈe ‡ l'offre
